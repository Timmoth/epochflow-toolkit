...
public class GetDataRequest
{
    ...
    public static GetDataRequest Create(long start, long end, string source, string tag,
    ...
    {
        return Start == other.Start && End == other.End && Equals(Source, other.Source) && Equals(Tag, other.Tag) &&
    ...
    public override int GetHashCode()
    {
        ...
        return HashCode.Combine(Start, End, Source, Tag, Resolution, Aggregation, filtersHashCode);
    }
}