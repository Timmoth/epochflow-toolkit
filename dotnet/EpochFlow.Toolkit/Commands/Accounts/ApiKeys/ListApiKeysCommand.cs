...
public sealed class ListApiKeysCommand : AsyncCommand<ListApiKeysCommand.Settings>
{
    private readonly ILogger<ListApiKeysCommand> _logger;
    private readonly IServiceProvider _serviceProvider;

    public ListApiKeysCommand(ILogger<ListApiKeysCommand> logger, IServiceProvider serviceProvider)
    {
        _logger = logger;
    ...
    public override async Task<int> ExecuteAsync(CommandContext context, Settings settings)
    {
        ...
        var response = await epochFlowApi.ListApiKeys();
        stopwatch.Stop();
